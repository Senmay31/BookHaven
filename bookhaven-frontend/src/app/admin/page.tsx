...
import { booksApi, adminApi, api } from "@/lib/api";
    ...
    <DashboardLayout>
      <div className="mb-6">
        ...
        <p className="font-sans text-slate-500 mt-1">
          Manage the library and its members
        </p>
      </div>
              ...
              <>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <StatCard
                    ...
                    sub={`+${stats.books.new_this_month} this month`}
                    color="bg-parchment-500"
                  />
                  <StatCard
                    icon={Star}
                    label="Total Reviews"
                  ...
                  <div className="bg-white rounded-xl border border-slate-100 shadow-card overflow-hidden">
                    ...
                    <div className="divide-y divide-slate-50">
                      {stats.popular_books.map((book: any, i: number) => (
                        ...
                        >
                          <span className="font-display text-2xl font-bold text-slate-200 w-6 text-center">
                            {i + 1}
                          </span>
                          <div className="flex-1 min-w-0">
                            <p className="font-sans font-medium text-slate-900 truncate">
                              {book.title}
                            </p>
                          ...
                          <div className="text-right">
                            <p className="font-sans font-semibold text-slate-800 text-sm">
                              {book.total_reads?.toLocaleString()} reads
                            </p>
            ...
            <form onSubmit={handleUpload} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Input
                  ...
                  value={bookForm.isbn}
                  onChange={(e) =>
                    setBookForm((p) => ({ ...p, isbn: e.target.value }))
                  }
                />
                <Input
                  label="Publisher"
                  ...
                  onChange={(e) =>
                    setBookForm((p) => ({ ...p, publisher: e.target.value }))
                  }
                />
                <Input
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setBookForm((p) => ({ ...p, pages: e.target.value }))
                  }
                />
              </div>
              ...
              <thead className="bg-slate-50 border-b border-slate-100">
                <tr>
                  {[
                    ...
                    <th
                      key={h}
                      className="text-left px-4 py-3 font-sans text-xs font-semibold text-slate-500 uppercase tracking-wider"
                    >
                      {h}
                    </th>
                  ))}
              ...
              <tbody className="divide-y divide-slate-50">
                {users?.map((u: any) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`text-xs font-sans font-medium px-2 py-0.5 rounded-full capitalize ${
                          u.role === "admin"
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`text-xs font-sans font-medium px-2 py-0.5 rounded-full ${u.is_active ? "bg-green-50 text-green-700" : "bg-red-50 text-red-600"}`}
                      >
